...
@Component({
    ...
    template: `
        <div>
            ...
            <button class="fi text-center directory location" title="New Root" (click)="onNewLocation.next()" *ngIf="newLocation !== null" [attr.disabled]="newLocation === false || null"><i></i></button>

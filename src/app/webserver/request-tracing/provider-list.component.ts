...
@Component({
    ...
    template: `
        <div *ngIf="_providers">
            <button class="create" (click)="create()" [class.inactive]="_editing"><i aria-hidden="true" class="sme-icon sme-icon-add color-active"></i><span>Create Provider</span></button>

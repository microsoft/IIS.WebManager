    ...
    template: `
        <div class="file-toolbar">
            <button
                ...
                *ngIf="refresh !== null" [attr.disabled]="refresh === false || null">
            ...
            <button
                class="fi text-center directory location"
                title="New Root"
                (click)="onNewLocation.next()"
                *ngIf="newLocation !== null"
                [attr.disabled]="newLocation === false || null">
                <i aria-hidden="true" class="color-normal"></i>
            </button>
            <button
                class="fi text-center directory"
                title="New Folder"

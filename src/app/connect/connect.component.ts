    ...
    <div class="center-page">
        <div *ngIf='!_connecting'>
            ...
            <div class="advanced" *ngIf="_connectionType == 'simple'">
                <button (click)="onAdvanced()">Remote Server or Manual Setup<i aria-hidden="true" class="sme-icon sme-icon-forward"></i></button>
            </div>
            <div class="simple" *ngIf="_connectionType == 'advanced' && !_disableSimple">
                <button (click)="onSimple()">Local Server Setup<i aria-hidden="true" class="sme-icon sme-icon-forward"></i></button>
            </div>
        </div>

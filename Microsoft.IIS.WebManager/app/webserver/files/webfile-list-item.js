...
var WebFileComponent = /** @class */ (function () {
    function WebFileComponent(_service, _fileService, _notificationService) {
    ...
    WebFileComponent.prototype.onBlur = function (event) {
    ...
    WebFileComponent.prototype.onDelete = function (e) {
        ...
        this._notificationService.confirm("Delete File", "Are you sure you want to delete " + this.model.name)
            ...
            if (confirmed) {
                _this._service.delete([_this.model]);
            }
        });
    };
...
//# sourceMappingURL=webfile-list-item.js.map